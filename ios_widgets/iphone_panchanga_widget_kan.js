...
try {
  ...
  const req = new Request(
    `${BASE_URL}/api/v1/all?lat=${lat}&lon=${lon}&lang=kan`
  );
  ...
  let line = widget.addText(
    `ಅಂತ್ಯ ${data.hora.ends}   •   ಮುಂದಿನ ಹೋರೆ ${data.hora.next}`
  );
